...
export default function SuperLikeModal({ pet, onClose, onSend }: Props) {
  ...
  const [message, setMessage] = useState(
    `Hi! I found ${pet.name} on PawSwap and I'm very interested in adopting. I'd love to schedule a visit to meet ${pet.gender === 'Male' ? 'him' : 'her'}. When would be a good time?`
  );
