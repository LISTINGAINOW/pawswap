    ...
    <div className="min-h-screen bg-sage-50 px-4 py-8">
      <div className="mx-auto max-w-lg">
        ...
        <div className="text-center">
          ...
          <h1 className="mt-4 text-4xl font-bold text-sage-700">PawSwap</h1>
        ...
        <div className="mt-10 space-y-8">
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed text-gray-600">
              Every year, millions of pets in shelters wait for someone to choose them. PawSwap makes finding your perfect match as easy as a swipe. We partner with shelters and rescue groups to bring you real, adoptable animals near you.
            </p>
            <p className="mt-3 leading-relaxed text-gray-600">
              <strong>PawSwap is 100% free.</strong> No ads, no paywalls. Just pets who need homes and humans who need pets.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed text-gray-600">
              Want your adoptable pets on PawSwap? We pull data from RescueGroups.org and Petfinder — if your shelter is listed there, your pets are already here. No extra work needed.
            </p>
          </section>
          ...
          <section className="rounded-2xl bg-sage-100 p-6 text-center">
            ...
            <p className="mt-3 font-medium text-sage-700">
              Built with love by the PawSwap team
            </p>
